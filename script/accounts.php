...
<th><a href="'.$_SERVER['PHP_SELF'].'?order=login'.(isset($_GET['dir']) && $_GET['dir']=='asc' ? '&dir=desc': '&dir=asc').'">Login</a></th>
<th>Days</th>
<th>Time to play</th>
<th>Login Counter</th>
<th><a href="'.$_SERVER['PHP_SELF'].'?order=currently_playing'.(isset($_GET['dir']) && $_GET['dir']=='asc' ? '&dir=desc': '&dir=asc').'">Currently Playing?</a></th>
</tr>';
